DROP SEQUENCE IF EXISTS shop_seq1;
DROP SEQUENCE IF EXISTS corner_seq1;
DROP SEQUENCE IF EXISTS template_seq1;
DROP SEQUENCE IF EXISTS shop_template_seq1;
DROP SEQUENCE IF EXISTS template_corner_seq1;
